    ...
    <div className="space-y-4">
      ...
      <div className="overflow-hidden rounded-2xl border border-[#E5E5EA] dark:border-[#2C2C2E]
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-[#007AFF]/[0.20] dark:bg-[#0A84FF]/[0.20]
              border-b border-[#007AFF]/[0.12] dark:border-[#0A84FF]/[0.12]">
          ...
          <tbody>
            {data.items.map((item, index) => (
              <tr key={item.id} 
                className={`border-t border-[#007AFF]/[0.10] dark:border-[#0A84FF]/[0.10]
                  ${index % 2 === 0 ? 'bg-transparent' : 'bg-[#007AFF]/[0.05] dark:bg-[#0A84FF]/[0.05]'}`}
              >

...
export default function PackingHistoryTab({
  ...
  return (
    <div className="overflow-hidden">
            ...
            >
              <div className="flex items-center w-full">
                ...
                <div className="w-24 sm:w-40 flex-shrink-0">
                  <div className="whitespace-nowrap text-sm font-bold text-teal-600 dark:text-teal-400 font-mono">
                    {item.invoiceNo || '-'}
                  </div>
                </div>
                ...
                <div className="w-10 sm:w-32 flex-shrink-0 flex items-center justify-center">
                  <div className="flex items-center justify-end space-x-1">
                    <button
                      ...
                      className="p-2 text-gray-400 hover:text-teal-600 hover:bg-teal-50 dark:hover:text-teal-400 dark:hover:bg-teal-900/20 rounded-lg transition-all duration-200"
                      title="预览"
                    >
      ...
      {/* 金额统计 */}
      {history.length > 0 && (
        <div className="bg-gradient-to-r from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 border-t border-teal-200 dark:border-teal-800 px-4 py-3">

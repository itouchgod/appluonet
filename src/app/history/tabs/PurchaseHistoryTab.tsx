...
export default function PurchaseHistoryTab({ 
  ...
  return (
    <div className="overflow-hidden">
      ...
      {/* 金额统计 */}
      {history.length > 0 && (
        <div className="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 border-t border-orange-200 dark:border-orange-800 px-4 py-3">

      ...
      <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 px-4 py-4 border-b border-gray-200 dark:border-gray-600">
        <div className="flex items-center w-full">
          ...
          <button
            ...
            className={`flex-1 min-w-0 truncate font-semibold pl-2 text-left hover:text-green-600 dark:hover:text-green-400 transition-colors flex items-center group whitespace-nowrap text-${mainColor}-600 dark:text-${mainColor}-400`}
          >
            客户名称
          ...
          <button
            ...
            className={`w-24 sm:w-40 flex-shrink-0 font-semibold pl-2 text-left hover:text-green-600 dark:hover:text-green-400 transition-colors flex items-center group whitespace-nowrap text-${mainColor}-600 dark:text-${mainColor}-400`}
          >
            合同号
          ...
          <button
            ...
            className={`hidden md:flex w-36 flex-shrink-0 font-semibold pl-2 text-left hover:text-green-600 dark:hover:text-green-400 transition-colors flex items-center group whitespace-nowrap text-${mainColor}-600 dark:text-${mainColor}-400`}
          >
            金额
          ...
          <button
            ...
            className={`hidden lg:flex w-40 flex-shrink-0 font-semibold pl-2 text-left hover:text-green-600 dark:hover:text-green-400 transition-colors flex items-center group whitespace-nowrap text-${mainColor}-600 dark:text-${mainColor}-400`}
          >
            创建时间
            ...
            >
              <div className="flex items-center w-full">
                ...
                <div className="w-24 sm:w-40 flex-shrink-0">
                  <div className="whitespace-nowrap text-sm font-bold text-green-600 dark:text-green-400 font-mono">
                    {contractNo}
                  </div>
                </div>
